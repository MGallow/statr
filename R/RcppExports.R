...
CV_logisticc <- function(X, y, lam = 0L, alpha = 0L, penalty = "none", 
    ...
    .Call("statr_CV_logisticc", PACKAGE = "statr", X, y, lam, alpha, 
        penalty, intercept, method, tol, maxit, vec, init, criteria, 
        K)
}
...
CV_linearc <- function(X, y, lam = 0L, alpha = 0L, penalty = "none", 
    ...
    .Call("statr_CV_linearc", PACKAGE = "statr", X, y, lam, alpha, 
        penalty, weights, intercept, kernel, method, tol, maxit, vec, 
        init, K)
}
...
gradient_IRLS_logisticc <- function(betas, X, y, lam = 0, vec = 0L) {
    .Call("statr_gradient_IRLS_logisticc", PACKAGE = "statr", betas, 
        X, y, lam, vec)
}
...
IRLSc <- function(X, y, lam = 0, penalty = "none", intercept = TRUE, 
    ...
    .Call("statr_IRLSc", PACKAGE = "statr", X, y, lam, penalty, intercept, 
        tol, maxit, vec, init)
}
...
gradient_MM_logisticc <- function(betas, X, y, lam = 0, alpha = 1.5, 
    gamma = 1, vec = 0L) {
    .Call("statr_gradient_MM_logisticc", PACKAGE = "statr", betas, 
        X, y, lam, alpha, gamma, vec)
}
...
gradient_MM_linearc <- function(betas, X, y, lam = 0, alpha = 1.5, 
    ...
    .Call("statr_gradient_MM_linearc", PACKAGE = "statr", betas, X, 
        y, lam, alpha, gamma, weights, vec)
}
...
MMc <- function(X, y, lam = 0, alpha = 1.5, gamma = 1, intercept = TRUE, 
    tol = 1e-05, maxit = 1e+05, vec = 0L, init = 0L) {
    .Call("statr_MMc", PACKAGE = "statr", X, y, lam, alpha, gamma, 
...
#' MM_linearc(X, y)
#'
MM_linearc <- function(X, y, lam = 0, alpha = 1.5, gamma = 1, weights = 0L, 
    intercept = TRUE, tol = 1e-05, maxit = 1e+05, vec = 0L, init = 0L) {
    .Call("statr_MM_linearc", PACKAGE = "statr", X, y, lam, alpha, 
        gamma, weights, intercept, tol, maxit, vec, init)
}
...
gradient_linearc <- function(betas, X, y, lam = 0, weights = 0L, intercept = TRUE) {
    .Call("statr_gradient_linearc", PACKAGE = "statr", betas, X, y, 
        lam, weights, intercept)
}
...
SVDc <- function(X, y, lam = 0, weights = 0L, intercept = TRUE, kernel = FALSE) {
    .Call("statr_SVDc", PACKAGE = "statr", X, y, lam, weights, intercept, 
        kernel)
}
...
linearc <- function(X, y, lam = 0, alpha = 1.5, penalty = "none", 
    weights = 0L, intercept = TRUE, kernel = FALSE, method = "SVD", 
    tol = 1e-05, maxit = 1e+05, vec = 0L, init = 0L) {
    .Call("statr_linearc", PACKAGE = "statr", X, y, lam, alpha, penalty, 
        weights, intercept, kernel, method, tol, maxit, vec, init)
}
...
logisticc <- function(X, y, lam = 0, alpha = 1.5, penalty = "none", 
    ...
    vec = 0L, init = 0L) {
    .Call("statr_logisticc", PACKAGE = "statr", X, y, lam, alpha, 
        penalty, intercept, method, tol, maxit, vec, init)
}
...
predict_logisticc <- function(betas, X, y = 0L) {
    .Call("statr_predict_logisticc", PACKAGE = "statr", betas, X, 
        y)
}
