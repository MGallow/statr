...
CV_logisticc <- function(X, y, lam = 0L, alpha = 0L, penalty = "none", 
    ...
    .Call("statr_CV_logisticc", PACKAGE = "statr", X, y, lam, alpha, 
        penalty, intercept, method, tol, maxit, vec, K)
}
...
CV_linearc <- function(X, y, lam = 0L, alpha = 0L, penalty = "none", 
    ...
    tol = 1e-05, maxit = 10000, vec = 0L, K = 5L) {
...
gradient_MM_linearc <- function(betas, X, y, lam = 0, alpha = 1.5, 
    ...
    .Call("statr_gradient_MM_linearc", PACKAGE = "statr", betas, 
        X, y, lam, alpha, gamma, weights, vec)
}
...
MM_linearc <- function(X, y, lam = 0, alpha = 1.5, gamma = 1, weights = 0L, 
    intercept = TRUE, tol = 1e-05, maxit = 1e+05, vec = 0L) {
    .Call("statr_MM_linearc", PACKAGE = "statr", X, y, lam, alpha, 
        gamma, weights, intercept, tol, maxit, vec)
}
...
gradient_linearc <- function(betas, X, y, lam = 0, weights = 0L, 
    intercept = TRUE) {
    .Call("statr_gradient_linearc", PACKAGE = "statr", betas, X, 
        y, lam, weights, intercept)
}
...
linearc <- function(X, y, lam = 0, alpha = 1.5, penalty = "none", 
    ...
    .Call("statr_linearc", PACKAGE = "statr", X, y, lam, alpha, penalty, 
        weights, intercept, kernel, method, tol, maxit, vec)
}
...
logisticc <- function(X, y, lam = 0, alpha = 1.5, penalty = "none", 
    ...
    .Call("statr_logisticc", PACKAGE = "statr", X, y, lam, alpha, 
        penalty, intercept, method, tol, maxit, vec)
}
